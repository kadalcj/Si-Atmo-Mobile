...
class WebViewNotaLunasActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView.loadUrl(BASEURL + "nota/printPreview/" + noPemesanan)
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        ...
        when(item?.itemId) {
            R.id.btnCetak-> {
                ...
                openURL.data = Uri.parse(BASEURL + "nota/printPreview/" + noPemesanan)
